...
import com.engamsba.noteapplication.databinding.SplashFargmentBinding
...
@AndroidEntryPoint
class SplashFragment(override val layout: Int = R.layout.splash_fargment)
    :BaseFragment<SplashFargmentBinding, MainViewModel>() {
